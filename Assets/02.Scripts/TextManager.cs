...
{
    Dictionary<string, string[]> m_Tutorial; //튜토리얼 종류와 대화배열
    ...
    void GenerateDate()
    {
        m_Tutorial.Add("소환하기", new string[] { "우선 숫자 캐릭터를 소환해 볼까요?",
                        "소환을 하기 위해서는 이 버튼을 눌러야합니다.",
                        "소환비용은 100골드에요. 총 5번 소환해봅시다."});

        m_Tutorial.Add("조합하기", new string[] { "이번에는 숫자 캐릭터들을 조합해볼거에요",
